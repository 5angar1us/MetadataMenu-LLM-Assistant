<script lang="ts">
	...
	import { getFrontmatter, addFrontmatterSetting } from 'MetadataEnricher/frontmatter';
	import { getRawSupportedFields, getSupportedFieldsWitOptionsFromRaw, type RichField } from 'MetadataMenuOptionsResolver/Fields';
